                ...
                <>
                  <Row>
                    ...
                    <Colxx xs="12" md="6">
                      ...
                      <Input
                        placeholde0r="What Will Students Learn After this Chapter"
                        type="textarea"
                        name="conclusion"
            ...
            /> */}
                              ...
                              <Colxx xs="12" md="6">
                                <Row>
                                  ...
                                  >
                                    <div
                                      className={`glyph-icon ${iconsmind[28].icons[8]} sessionlookicon`}
                                    />
                                  ...
                                  >
                                    <div
                                      className={`glyph-icon ${simplelineicons[151]} mr-2 sessionlookicon`}
                                    />
                                  ...
                                  >
                                    <div
                                      className={`glyph-icon ${simplelineicons[157]} mr-2 sessionlookicon`}
                                    />
                                  ...
                                  <Colxx xxs="12" sm="6" lg="3">
                                    <div className="iconcolumn">
                                      <div
                                        className={`glyph-icon ${iconsmind[28].icons[7]} sessionlookicon`}
                                      />
