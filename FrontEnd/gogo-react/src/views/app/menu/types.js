...
<TabPane tabId="7">
    ...
    <Scrollbars style={{ width: '100%', height: 400 }}>
      <CardBody style={{width:'100%'}}>
        <Table columns={cols21} data={countries} /> 
      </CardBody>
      </Scrollbars>
    </Card>
    </Col>
    ...
    <Card className="h-140  ">
      <CardBody style={{width:'100%'}}>
        <Table columns={cols22} data={cities} /> 
      </CardBody>
      </Card>
      </Scrollbars>
    </Col>
    ...
    <Card className="h-140  ">
      <CardBody style={{width:'100%'}}>
        <Table columns={cols23} data={d_countries} /> 
      </CardBody>
      </Card>
      </Scrollbars>
    </Col>
    ...
    <Card className="h-140  ">
      <CardBody style={{width:'100%'}}>
        <Table columns={cols24} data={device} /> 
      </CardBody>
      </Card>
      </Scrollbars>
    </Col>
